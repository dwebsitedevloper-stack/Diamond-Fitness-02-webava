...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center overflow-hidden ice-gradient"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-32 text-center">
        <div className="animate-fadeInUp">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-2xl mx-auto font-light">
            Experience the pinnacle of wellness in our crystal-clean,
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <button
              ...
              className="group glass-strong hover:crystal-glow px-8 py-4 rounded-full transition-all duration-300 flex items-center space-x-2"
            >
            ...
            <a
              href="https://www.youtube.com" // replace with your actual tour video link
              target="_blank"
              rel="noopener noreferrer"
              className="group glass-strong hover:crystal-glow px-8 py-4 rounded-full transition-all duration-300 flex items-center space-x-2"
            >
              <span className="font-medium text-gray-800">Gym Tour</span>
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </a>
          </div>
        </div>
